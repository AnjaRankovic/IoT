...
//     // Popravljeno na tvoju novu IP adresu i port 8811
...
//     // Salje podatak samo ako se vrednost promenila za vise od 15 crtica
//     if (abs(vrednostPotenciometra - prethodnaVrednost) > 15)
//     {
//         Serial.println(vrednostPotenciometra);

//         // Promenjen kljuc u tipPoruke da se poklapa sa Node.js i HTML-om
//         dataString = R"({"tipPoruke":"potenciometar","pin":34,"vrednost":)";
